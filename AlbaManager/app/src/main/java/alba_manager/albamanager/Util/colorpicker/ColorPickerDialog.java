package alba_manager.albamanager.Util.colorpicker;
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.calendar_color_picker_dialog, container, false);

        // Set title for this dialog
        getDialog().setTitle(getString(R.string.regialba_color_title));

        mProgress = (ProgressBar) v.findViewById(android.R.id.progress);
        mPalette = (ColorPickerPalette) v.findViewById(R.id.color_picker);
        mPalette.init(mSize, mColumns, this);
