...
public class ScheduleCaldroidAdapter extends CaldroidGridAdapter {

    public ScheduleCaldroidAdapter(Context context, int month, int year,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // For reuse
        if (convertView == null) {
            cellView = inflater.inflate(R.layout.schedule_cell, null);
        }
        ...
        TextView cellTextViewDay = (TextView) cellView.findViewById(R.id.scheduleCellTextViewDay);
